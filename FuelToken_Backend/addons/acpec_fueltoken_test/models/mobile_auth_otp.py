...
class AcpecMobileAuthOtp(models.Model):
    ...
    def _send_otp_code(self, code):
        for challenge in self:
            ...
            challenge.message_post(
                body=_('OTP local de test pret pour %s : 0000. Aucun SMS envoye.') % (
    ...
    def verify(self, code):
        # Module de test uniquement : accepter l'OTP local a 4 chiffres 0000.
        ...
        if code != '0000':
            # En mode test local, seul 0000 est accepte. On conserve la logique
