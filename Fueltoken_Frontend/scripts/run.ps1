...
$extraKeys = @(
    ...
    "ODOO_RPC_FUEL_QR_DETAIL_PATH", "ODOO_RPC_FUEL_QR_SPLIT_PATH", "ODOO_RPC_FUEL_QR_RETIRER_PATH",
    "ODOO_RPC_FUEL_QR_SEPARER_PATH", "ODOO_RPC_FUEL_CARNETS_TRANSFER_PATH", "ODOO_RPC_FUEL_STATION_QR_USE_PATH"
)
