...
class AppRouter {
  static GoRouter build(AuthBloc authBloc) {
    return GoRouter(
      ...
      routes: [
          ...
          builder: (ctx, st) {
            ...
            if (x is! ForgotOtpRouteArgs) {
              return const Scaffold(
                body: Center(
                  child: Text('Reprendre depuis mot de passe oubliÃ©.'),
                ),
              );
            }
        ...
        GoRoute(
          ...
          builder: (ctx, st) {
            ...
            if (x is! ForgotResetRouteArgs) {
              return const Scaffold(
                body: Center(
                  child: Text('Reprendre depuis la vÃ©rification OTP.'),
                ),
              );
            }
        ...
        GoRoute(
          ...
          builder: (ctx, st) {
            ...
            if (x is! RegisterOtpRouteArgs) {
              return const Scaffold(
                body: Center(child: Text('Reprendre depuis lâ€™inscription.')),
              );
            }
        ...
        // user â€” navigation principale (5 onglets)
        ...
        // station â€” 3 onglets (mÃªme barre animÃ©e que le client, accents bleus)
        StatefulShellRoute.indexedStack(
          builder: (context, state, navigationShell) {
        ...
        // admin â€” 4 onglets (accent violet)
        StatefulShellRoute.indexedStack(
          builder: (context, state, navigationShell) {
          ...
          builder: (_, st) {
            ...
            if (extra is! AccountRequestItem) {
              return Scaffold(
                ...
                body: const Center(
                  child: Text('Demande introuvable. Revenez Ã  la liste.'),
                ),
              );
            }
  ...
  /// Ã‰crans rÃ©servÃ©s au profil Â« client Â» â€” un compte admin ne doit pas sâ€™y retrouver par erreur.
