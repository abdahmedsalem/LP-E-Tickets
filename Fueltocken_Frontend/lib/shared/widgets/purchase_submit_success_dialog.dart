...
class _PurchaseSuccessDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final payRef = clientPaymentReference?.trim().isNotEmpty == true
        ? clientPaymentReference!.trim()
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  _DetailCard(
                    scheme: scheme,
                    label: 'Code public',
                    value: result.publicCode,
                    mono: true,
                    trailing: IconButton(
                      tooltip: 'Copier',
                      onPressed: () async {
                        await Clipboard.setData(
                          ClipboardData(text: result.publicCode),
                        );
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Code public copié.'),
                  ...
                  if (payRef != null && payRef.isNotEmpty) ...[
                    const SizedBox(height: 10),
                    _DetailCard(
                      scheme: scheme,
            ...
            Padding(
              ...
              child: Text(
                'Conservez le code public : il pourra vous être demandé pour le suivi.',
