    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Ink(
          ...
          child: SizedBox(
            height: wide ? (compact ? 59 : 88) : 128,
            child: Padding(
              padding: EdgeInsets.symmetric(
                horizontal: 12,
                vertical: wide ? (compact ? 8 : 12) : 12,
              ),
              child: wide && compact
                  ? Row(
                      children: [
                  ...
                  : Column(
                      ...
                      children: [
                        Container(
                          width: wide ? (compact ? 36 : 42) : 46,
                          height: wide ? (compact ? 36 : 42) : 46,
                          decoration: BoxDecoration(
                            color: accent.withValues(alpha: 0.12),
                            shape: BoxShape.circle,
                          ),
                          child: Icon(
                            icon,
                            color: accent,
                            size: wide ? (compact ? 18 : 22) : 24,
                          ),
                        ),
                        SizedBox(height: wide ? (compact ? 5 : 10) : 10),
                        Text(
                          title,
                          ...
                          style: TextStyle(
                            fontWeight: FontWeight.w800,
                            fontSize: wide ? (compact ? 12.5 : 14) : 13,
                            color: scheme.onSurface,
                            height: 1.05,
                          ),
                        ),
