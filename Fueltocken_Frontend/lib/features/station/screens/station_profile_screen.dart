...
/// Profil station / opÃ©rateur (donnÃ©es retirÃ©es de lâ€™accueil).
      ...
      appBar: AppBar(
        ...
        actions: [
          IconBtn(
            ...
            onPressed: () => context.go('/station/journal'),
          ),
      ...
      body: ListView(
        ...
        children: [
              ...
              child: Column(
                children: [
                  ...
                  _ProfileSubCard(
                    ...
                    compact: true,
                    rows: [
                      _ProfileRow('Nom', ap.operatorName),
                      _ProfileRow('E-mail', ap.operatorEmail),
                      _ProfileRow(
                        'Téléphone',
                        ap.operatorPhone.isEmpty ? '—' : ap.operatorPhone,
                      ),
                      _ProfileRow('ID', ap.operatorId, mono: true),
                    ],
                  ),
                ],
              ),
          ...
          if (useAcpec) ...[
            ...
            if (ap != null) _AcpecStationProfilePanel(profile: ap),
          ] else ...[
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Text(
            'Station liÃ©e et opÃ©rateur mobile (ACPEC).',
            style: TextStyle(
              fontSize: 11,
              height: 1.35,
              fontWeight: FontWeight.w600,
        ...
        _ProfileSubCard(
          ...
          rows: [
            ...
            _ProfileRow(
              'TÃ©lÃ©phone',
              profile.operatorPhone.isEmpty ? 'â€”' : profile.operatorPhone,
            ),
